...
var BASE_PACKAGE = {
  description: 'A full Bitcoin Private node build with Bitcore',
  repository: 'https://github.com/BTCPrivate/bitcore-node',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib': 'BTCPrivate/bitcore-lib',
    'bitcore-node': 'BTCPrivate/bitcore-node'
  }
};
